...
public class ContainerGrinder extends Container {
    ...
    public ContainerGrinder(InventoryPlayer parInventoryPlayer, IInventory parIInventory) {
        ...
        // Input Slot
        addSlotToContainer(new Slot(tileGrinder, TileEntityGrinder.slotEnum.INPUT_SLOT.ordinal(), 59, 35));

        // Energy Slot
        addSlotToContainer(new Slot(tileGrinder, TileEntityGrinder.slotEnum.ENERGY_SLOT.ordinal(), 8, 58));
    ...
    public void onCraftGuiOpened(ICrafting listener) {
        ...
        listener.sendAllWindowProperties(this, this.tileGrinder);
    }
    ...
    public void detectAndSendChanges() {
        ...
        for (int i = 0; i < crafters.size(); ++i) {
            ...
            if(energy != tileGrinder.getField(4)) {
