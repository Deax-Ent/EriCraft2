...
public class SlotGrinderOutput extends Slot {
    ...
    public SlotGrinderOutput(EntityPlayer player, IInventory iinventory, int slot, int xDisplayPos, int yDisplayPos) {
        super(iinventory, slot, xDisplayPos, yDisplayPos);
        thePlayer = player;
    }
